    ...
    public O handleRequest(I input, Context context) {
        try {
            ...
            if (applicationContext == null) {
                LOG.info("ApplicationContext does not exist. Initializing with Config({})", SnsConfig.class);
                applicationContext = new AnnotationConfigApplicationContext(SnsConfig.class);
            }
